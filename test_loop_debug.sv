...
module test_loop_debug;
    ...
    initial begin
        ...
        while (!hlt && cycle_count < 200) begin
            ...
            $display("C%0d: v1=%b v2=%b op1=%h op2=%h stall=%b(rob=%b fl=%b tf1=%b hlt=%b hc=%b) pred=%b pred2=%b flush=%b rob_h=%0d rob_t=%0d",
                cycle_count,
                dut.fu_out_valid1, dut.fu_out_valid2,
                dut.opcode1, dut.opcode2,
                dut.decode_stall, !dut.rob_inst.can_alloc2, !dut.fl_inst.can_alloc2,
                (dut.fu_out_valid1 && dut.target_full1),
                dut.hlt, dut.rob_inst.halt_committed,
                dut.branch_pred1, dut.branch_pred2,
                dut.flush,
                dut.rob_inst.head, dut.rob_inst.tail);
        end

        $display("Cycles: %0d, r1=%0d", cycle_count, dut.reg_file.registers[1]);
        $finish;
    end
endmodule
